...
public class WaterSharkBombJutsuRenderer extends EntityRenderer<WaterSharkBombEntity> {
   public static final ResourceLocation WATER_BULLET_TEX = new ResourceLocation("narutomod", "textures/entity/jutsu/projectiles/water_shark_bomb.png");
   private static final RenderType RENDER_TYPE = RenderType.entityTranslucent(WATER_BULLET_TEX);
   private final Watahsharkbakudan model;

   public WaterSharkBombJutsuRenderer(EntityRendererProvider.Context manager) {
      super(manager);
      this.model = new Watahsharkbakudan(manager.bakeLayer(Watahsharkbakudan.LAYER_LOCATION));
   }

   @Override
   public void render(WaterSharkBombEntity entity, float p_114486_, float partialTicks, PoseStack poseStack, MultiBufferSource multiBufferSource, int p_114490_) {
   ...
   @Override
   public ResourceLocation getTextureLocation(WaterSharkBombEntity p_114482_) {
