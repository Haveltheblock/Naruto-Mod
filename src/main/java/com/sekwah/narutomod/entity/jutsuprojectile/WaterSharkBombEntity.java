...
public class WaterSharkBombEntity extends AbstractNonGlowingHurtingProjectile {
    ...
    public WaterSharkBombEntity(EntityType<WaterSharkBombEntity> entityConstructor, Level level) {
        super(entityConstructor, level);
    }

    public WaterSharkBombEntity(EntityType<? extends AbstractNonGlowingHurtingProjectile> entityType, double posX, double posY, double posZ, double velX, double velY, double velZ, Level p_36824_) {
    ...
    public WaterSharkBombEntity(LivingEntity player, double xVel, double yVel, double zVel) {
        this(NarutoEntities.WATERSHARKBOMB_JUTSU.get(), player.getX(), player.getEyeY() - 0.15f, player.getZ(),  xVel, yVel, zVel, player.level());
